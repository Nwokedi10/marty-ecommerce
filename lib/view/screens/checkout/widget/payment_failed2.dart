...
class PaymentFailedDialog2 extends StatelessWidget {
  final String? orderID;
  final double? orderAmount;
  const PaymentFailedDialog2({Key? key, required this.orderID, required this.orderAmount}) : super(key: key);
      ...
      child: SizedBox(width: 500, child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(
            ...
            child: Text(
              'transaction_failed'.tr, textAlign: TextAlign.center,
          ...
          GetBuilder<OrderController>(builder: (orderController) {
            return !orderController.isLoading ? Column(children: [
              ...
              TextButton(
                ...
                child: Text('back_to_home'.tr, textAlign: TextAlign.center, style: robotoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
              ),
