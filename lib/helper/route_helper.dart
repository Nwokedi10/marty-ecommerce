...
import '../view/screens/checkout/funding_screen.dart';
import '../view/screens/checkout/funding_successful_screen.dart';
import '../view/screens/fund_wallet/fund_wallet.dart';
...
class RouteHelper {
  ...
  static const String fundingSuccess = '/funding-successful';
  ...
  static String getFundingSuccessRoute(String transID) {
    return '$fundingSuccess?id=$transID';
  }
  ...
  static String getFundingRoute(String id, int? user, String? type, double amount) => '$funding?id=$id&user=$user&type=$type&amount=$amount';
  ...
  static String getFundWalletRoute() => fundWallet;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: fundingSuccess, page: () => getRoute(FundingSuccessfulScreen(orderID: Get.parameters['id']),
    )),
    ...
    GetPage(name: funding, page: () => getRoute(FundingScreen(amount: double.parse(Get.parameters['amount']!), id: int.parse(Get.parameters['id']!), userId: int.parse(Get.parameters['user']!))
    )),
    ...
    GetPage(name: fundWallet, page: () => getRoute(const FundWalletScreen())),
